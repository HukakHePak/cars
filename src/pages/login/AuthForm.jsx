...
function AuthForm() {
  ...
  return (
    <Form fluid formValue={form} className={style.form} onChange={setForm} onSubmit={onSubmit}>
      ...
      <Form.HelpText className={style.error}>{auth.error.password}</Form.HelpText>
